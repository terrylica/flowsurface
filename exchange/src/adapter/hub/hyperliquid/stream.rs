//! NOTE(fork): WebSocket stream half of the hyperliquid hub adapter — merge phase 1.
//! GitHub Issue: https://github.com/terrylica/flowsurface/issues/30
//!
//! EMPTY skeleton. The port of `adapter/hyperliquid.rs`'s stream path lands here,
