...
- [x] **PANE-02**: Stream setup logic (OdbKline + Trades + Depth wiring) extracted to `pane/stream_setup.rs` (~700 LOC reduction)
- [x] **PANE-03**: pane.rs reduced below 1500 LOC after extractions while preserving all existing behavior
